...
HD_PWD='C:/EEE3313_projects/final_project/final_project.runs/audio_system_axi_fifo_mm_s_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_system_axi_fifo_mm_s_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_system_axi_fifo_mm_s_1_0.tcl
